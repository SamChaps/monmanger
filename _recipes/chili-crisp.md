...
1. **Heat the oil.** Pour the oil into a pot over medium-high heat and bring to 175 °C (350 °F).
2. **Fry the aromatics.** Add the chopped peanuts, minced garlic, and shallot. Fry for 1 to 2 minutes until golden brown. Scoop them out with a fine mesh strainer and set aside.
3. **Bloom the chili flakes.** Bring the oil back to 175 °C (350 °F). Add the chili flakes, Sichuan peppercorns, sugar, and salt. Immediately turn off the heat and let the residual heat toast the chili.
4. **Combine everything.** Once the mixture has cooled, stir the fried garlic, shallots, and peanuts back in. Add the lemon zest and sesame seeds.
5. **Store.** Transfer to a clean glass jar. Keeps in the fridge for 3 to 6 months.
