...
Deeply chocolatey brownies that are fudgy in the center with perfectly crispy edges. Made with olive oil for a rich, sophisticated flavor that pairs beautifully with cocoa. Let them cool completely for the best texture.
...
1. **Preheat** the oven to 165 C (325 F). Line a 20 cm (8x8-inch) baking dish with parchment paper and lightly grease.
...
5. **Pour** the thick batter into the prepared pan and smooth the top with a spatula. Bake 40-48 minutes, until a toothpick comes out with just a few crumbs.
6. **Cool** completely (about 2 hours) before slicing. The brownies will set further as they cool.

## Notes & Tips

- Use a 20 cm (8x8-inch) dish, not a larger one, or the brownies will overcook.
- Olive oil adds a rich flavor that pairs well with chocolate. For a neutral taste, use canola oil.
- The sugar can be reduced to 200 g (1 cup) for a less sweet version.
- Store in an airtight container at room temperature up to 3 days. Freezes well.
