...
A simple and satisfying wrap built around smoky tempeh bacon. Thin slices of tempeh are braised in a maple-liquid smoke glaze, then pan-fried until crispy and tucked into tortillas with fresh tomato, lettuce, and vegan mayo.
...
1. **Arrange the tempeh** slices side by side in a skillet.
2. **Mix the glaze.** Combine the garlic powder, maple syrup, vegetable oil, liquid smoke, vegetable broth, and salt in a bowl. Pour over the tempeh.
3. **Bring to a boil,** then lower the heat. Simmer until all the liquid is absorbed, about 5 minutes.
4. **Add a bit more oil** if needed and grill the tempeh slices until nicely browned on each side.
5. **Assemble the tortillas.** Place the crispy tempeh on each tortilla, top with sliced tomatoes, lettuce, and a generous spread of vegan mayo. Roll up and serve.

## Notes & Tips

- Keeps up to 5 days in the fridge and reheats well. Also good served cold.
- Double the tempeh batch and keep extras for sandwiches, grain bowls, or breakfast wraps.
- Adjust liquid smoke to taste: start with 1/2 tsp if you prefer a milder smokiness.
