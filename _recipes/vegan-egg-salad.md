...
1. **Press** the tofu for at least 30 minutes to remove excess liquid.
2. **Mash** half the tofu in a mixing bowl with the vegan mayo, mustard, and turmeric (if using) to create a thick dressing base.
3. **Chop** the remaining tofu coarsely to mimic the texture of chopped egg whites. Add to the bowl.
4. **Fold** in the celery, green onion, dill, black salt, and pepper. Mix gently.
5. **Taste** and adjust: add more dill, mustard, lemon juice, or salt as desired.
6. **Serve** immediately or refrigerate for 1-2 hours to let the flavors develop.
